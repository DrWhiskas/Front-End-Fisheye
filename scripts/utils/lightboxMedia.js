function CreateMedia(src, cible, array, count, isVideo) {
	...
	if (isVideo) {
		// Si c'est une vidéo, crée un élément source et configure les attributs nécessaires
		...
		// Si c'est une image, configure le src de l'élément image et ajoute une classe CSS
